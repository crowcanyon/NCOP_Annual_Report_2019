...
\hypersetup{
  pdftitle={The Northern Chaco Outliers Project},
  colorlinks=true,
  linkcolor=Maroon,
  filecolor=Maroon,
  citecolor=Blue,
...
{\centering \includegraphics[width=0.8\linewidth]{media/image3} 

}

\caption{Map showing location of Haynie site, Ida Jean site, Wallace Ruin, and other Chaco--period great houses within southwestern Colorado.}\label{fig:image3}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{media/image4} 

}

\caption{Map showing the East and West Great Houses at the Haynie site, and the boundary of The Archaeological Conservancy property. Selected archaeological features, excavation areas (including some prior to Crow Canyon involvement in the site), and modern buildings are shown.}\label{fig:image4}
\end{figure}
...
drainages and by current agricultural use of the land. Figure \ref{fig:image5} shows
...
{\centering \includegraphics[width=0.8\linewidth]{media/image5} 

}

\caption{Google Earth satellite image showing landscape of the Lakeview Group, with locations of Haynie site, Wallace Ruin, and Ida Jean site.}\label{fig:image5}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{media/image7} 

}

\caption{Map showing location of segments in Architectural Block 100 of the Haynie site.}\label{fig:image7}
\end{figure}
...
Excavation Area a letter (e.g.~Area A, Area B). Figure \ref{fig:image6} shows the
location of Excavation Areas within Architectural Block 100 of the
Haynie site.

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{media/image6} 

}

\caption{Map showing the location of Excavation Areas in Architectural Block 100 of the Haynie site.}\label{fig:image6}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{media/image8} 

}

\caption{Location of numbered structures in Architectural Block 100 of the Haynie site. Locations of pit structures are dashed in, and should be considered approximate.}\label{fig:image8}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image9.jpeg}
\caption{Photo showing wall segment or structure corner beneath floor of Structure 1010.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image10.jpeg}
\caption{Artifacts on the floor (SR00-01) in the north half of Structure 1042.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image11.jpeg}
\caption{In progress excavation photo showing Structure 1016 wall alignment.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image12.jpeg}
\caption{Burned roof beam and well-preserved roofing material from Structure 1024.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image13.jpeg}
\caption{Final excavation photo of the floor surface in Structure 1024, showing northwest posthole, sand-filled pits, portion of complex sipapu, and paho marks.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image14.jpeg}
\caption{Photo showing extent of burned bulrush/cattail open-twined mat on floor of Structure 1024. Beams from roof fall are visible at the top of the image in the Excavation Unit profile face. The artifacts north of the mat are a mano and two sherds.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image15.jpeg}
\caption{Detail of burned open-twined mat. Arrow points to location of one crosswise row of weft thread.}
\end{figure}

\begin{figure}
\centering
\includegraphics{./media/image16.jpeg}
\caption{Lower end of mat, warp ends shown vertically, showing cut ends of flattened stems.}
\end{figure}
...
\addcontentsline{toc}{subsection}{Permanent Crow Canyon Field and Laboratory Staff}
...
\addcontentsline{toc}{subsection}{Seasonal Staff}
...
\addcontentsline{toc}{subsection}{IT Support Staff}
...
\addcontentsline{toc}{subsection}{Cultural Explorations Staff}
...
\addcontentsline{toc}{subsection}{Crow Canyon 2019 Interns}
...
\addcontentsline{toc}{subsection}{How to Cite this Publication}
...
\addcontentsline{toc}{subsection}{How to Request Permission to Borrow}
